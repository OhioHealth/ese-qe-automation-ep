...
public class TxtfileValidate {

	@Test
	  public void testTxtFileCreation() {
        TxtfileCreate.main(new String[]{});

        // Read the content of the created file
        StringBuilder content = new StringBuilder();
        try (BufferedReader reader = new BufferedReader(new FileReader("PEP_3dayXpilot_outgoing_110.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                content.append(line);
            }

            // Assert the content of the file matches the expected content
